...
#include "MazeGamePlayerCharacter.generated.h"
...
UCLASS()
class MAZEGAME3D_API AMazeGamePlayerCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	AMazeGamePlayerCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
